...
为什么是卡方分布？请查看[第一次作业第五题](https://hezhijian.netlify.com/post/homework1/)
...
分析R软件的`dslabs`包中的身高数据heights, 利用R软件完成以下问题。相关的R语言操作见 [https://hezhijian.netlify.com/post/ex2/](https://hezhijian.netlify.com/post/ex2/)
