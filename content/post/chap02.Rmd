...
$\mu$的置信度为$1-\alpha$的置信区间为$$\left[\bar{X}+a\frac{\sigma}{\sqrt{n}},\  \bar{X}+b\frac{\sigma}{\sqrt{n}}\right]$$
...
$$\left[\bar{X}-a\frac{S_n^*}{\sqrt{n}},\  \bar{X}+b\frac{S_n^*}{\sqrt{n}}\right]=\left[\bar{X}-a\frac{S_n}{\sqrt{n-1}},\  \bar{X}+b\frac{S_n}{\sqrt{n-1}}\right]$$
